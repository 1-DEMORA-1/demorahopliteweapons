...
public class ReaperScythe {
    ...
    public ItemStack createReaperScythe() {
        ...
        if (meta != null) {
            ...
            double damage = plugin.getConfig().getDouble("weapons.reaper_scythe.attribute_damage", 11.0);
            ...
            double attackSpeed = plugin.getConfig().getDouble("weapons.reaper_scythe.attack_speed", -2.4);
