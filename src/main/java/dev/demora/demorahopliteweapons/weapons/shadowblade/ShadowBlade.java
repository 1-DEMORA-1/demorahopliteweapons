...
public class ShadowBlade {
    ...
    public ItemStack createShadowBlade() {
        ...
        if (meta != null) {
            ...
            double damage = plugin.getConfig().getDouble("weapons.shadow_blade.attribute_damage", 11.0);
            ...
            double attackSpeed = plugin.getConfig().getDouble("weapons.shadow_blade.attack_speed", -2.4);
