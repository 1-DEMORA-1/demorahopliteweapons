...
public class AwakenedDragonKatana {
    ...
    public ItemStack createAwakenedDragonKatana() {
        ...
        double damage = plugin.getConfig().getDouble("weapons.awakened_dragon_katana.attribute_damage",
            reworkConfig.getDouble("awakened_dragon_katana.damage", 11.0));
        meta.addAttributeModifier(Attribute.GENERIC_ATTACK_DAMAGE,
            new AttributeModifier(UUID.randomUUID(), "generic.attack_damage", 
                damage,
                AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.HAND));
        
        double attackSpeed = plugin.getConfig().getDouble("weapons.awakened_dragon_katana.attack_speed", -2.4);
        meta.addAttributeModifier(Attribute.GENERIC_ATTACK_SPEED,
            new AttributeModifier(UUID.randomUUID(), "generic.attack_speed",
                attackSpeed,
                AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.HAND));
